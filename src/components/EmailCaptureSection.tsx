  ...
  return (
    <section className="py-20 md:py-28 bg-background">
      <div className="container mx-auto px-4 max-w-2xl text-center">
        ...
        <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-semibold text-primary mb-6">Join the Circle</h2>
              ...
              <div className="ml-form-embedBody row-form" style={{padding:'20px 20px 0 20px'}}>
                <form className="ml-block-form" action="https://assets.mailerlite.com/jsonp/2143726/forms/180874923059709145/subscribe" method="post" target="_blank">
                  <div style={{marginBottom:'10px'}}>
                    <label style={{color:'#7b2d3e',fontWeight:'bold',display:'block',marginBottom:'4px'}}>Name</label>
                  ...
                  <div style={{marginBottom:'20px'}}>
                    <label style={{color:'#7b2d3e',fontWeight:'bold',display:'block',marginBottom:'4px'}}>Email</label>
                  ...
                  <div style={{marginBottom:'20px'}}>
                    <button type="submit" style={{backgroundColor:'#7b2d3e',color:'#fff',border:'none',borderRadius:'15px',fontSize:'18px',fontWeight:'700',padding:'12px',width:'100%',cursor:'pointer'}}>Join the Gathering</button>
                  </div>
